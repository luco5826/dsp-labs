  ...
  return (
    <>
      ...
      <Pagination
        ...
        itemsCountPerPage={
          Number.parseInt(localStorage.getItem("totalItems")) ||
          0 / Number.parseInt(localStorage.getItem("totalPages")) ||
          0
        }
        totalItemsCount={
        ...
        pageSize={Number.parseInt(localStorage.getItem("totalPages")) || 0}
      />
    </>
  );
};
